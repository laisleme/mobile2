...
class App extends Component{
  ...
  setChuteUsuario(text){
    ...
    if(!value) return alert('Digite um valor inteiro')
  ...
  descobrir() {
    ...
    this.setState({ result: value == this.state.chuteUsuario ? 'Parabéns, voçê acertou!!' : 'Não foi dessa vez, voçê errou' })
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.frame}>
          <Image 
            source={{ uri: 'https://mundoconectado.com.br/uploads/chamadas/game-subway-surfers-imagem-divulgacao-kiloogames_1.jpg' }}
